...
#descriptive visualization
  ## one: histogram of the citation, bins with 10 counts
citation.hist <- ggplot(data.networks, aes(x=cited.by), binwidth(10)) +
...
```{r}
article.year.count.all <- ggplot(number.issues.by.year, aes(x= year, y=n.of.issues)) +
...
```{r}
article.year.networks <- ggplot(data.networks, aes(x=year), binwidth(10)) +
  geom_histogram(fill = "#9999CC") +
  xlab("Citation counts") + 
  ylab("Number of articles")

article.year.networks + theme_networks
```
